                ...
                <div>
                    <div className='flex flex-row gap-2 border-2 border-gray-600 mb-2 p-1'>
                        ...
                        <div className='flex flex-col justify-center w-full'>
                            ...
                            <input style={{ border: "solid gray 1px" }} required type="text" id="docNo" onChange={handleChange} name="docNo" />
                        </div>
                        <div className='flex flex-col justify-center w-full'>
                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Data inizio trasporto</label>
                            <input style={{ border: "solid gray 1px" }} required type="date" onChange={handleChange} name="docDate" />
                        </div>
                        <div className='flex flex-col justify-center w-full'>
                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Ora inizio trasporto</label>
                            <input style={{ border: "solid gray 1px" }} required type="time" onChange={handleChange} name="transportStartTime" />
                        </div>
                        <div className='flex flex-col justify-center w-full'>
                    ...
                    <div className='flex flex-row gap-2 border-2 border-gray-600 mb-2 p-1'>
                        ...
                        <div className='flex flex-col justify-center w-3/12'>
                            ...
                            <input style={{ border: "solid gray 1px" }} required type="text" name="recipientaddress" onChange={handleChange} value={selectedRecipitent.address} />
                        </div>
                        <div className='flex flex-col justify-center w-1/12'>
                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">CAP</label>
                            <input style={{ border: "solid gray 1px" }} required type="text" name="recipientPostalCode" onChange={handleChange} value={selectedRecipitent.postalcode} />
                        </div>
                        <div className='flex flex-col justify-center w-3/12'>
                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">
                                Città</label>
                            <input style={{ border: "solid gray 1px" }} required type="text" name="recipientCity" onChange={handleChange} value={selectedRecipitent.city} />
                        </div>
                        <div className='flex flex-col justify-center w-1/12'>
                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Provincia
                            </label>
                            <input style={{ border: "solid gray 1px" }} required type="text" name="recipientProvince" onChange={handleChange} />
                        </div>
                        <div className='flex flex-col justify-center w-1/12'>
                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Nazione</label>
                            <select style={{ border: "solid gray 1px" }} required name="recipientNation" onChange={handleChange}>
                    ...
                    <div className='flex flex-row gap-2 border-2 border-gray-600 mb-2 p-1'>
                        ...
                        <div className='flex flex-col justify-center w-3/12'>
                            ...
                            <input style={{ border: "solid gray 1px" }} required type="text" name="goodDestinationAddress" onChange={handleChange} />
                        </div>
                        <div className='flex flex-col justify-center w-3/12'>
                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">CAP</label>
                            <input style={{ border: "solid gray 1px" }} required type="text" name="goodDestinationPostalCode" onChange={handleChange} />
                        </div>

                        <div className='flex flex-col justify-center w-3/12'>
                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Città</label>
                            <input style={{ border: "solid gray 1px" }} required type="text" name="goodsDestinationCity" onChange={handleChange} />
                        </div>
                        <div className='flex flex-col justify-center w-1/12'>
                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Provincia
                            </label>
                            <input style={{ border: "solid gray 1px" }} required type="text" name="goodDestinationProvince" onChange={handleChange} />
                        </div>
                        <div className='flex flex-col justify-center w-1/12'>
                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0" >Nazione</label>
                    ...
                    <div className=' border-2 border-gray-600 mb-2 p-1'>
                                ...
                                return (
                                    <div className='flex gap-2'>
                                        <div className='flex flex-column justify-center w-3/12'>
                                            ...
                                            <input type="text" required style={{ border: "solid gray 1px", width: "100%" }} name="productDescription" placeholder="--Seleziona Descrizione--" onChange={handleProduct} value={val.productDescription} />
                                        </div>
                                        <div className='flex flex-col justify-center w-1/12  my-1 text-center'>
                                            ...
                                            <input style={{ border: "solid gray 1px", width: "100%", textAlign: "center" }} required placeholder=".." type="text" name="Packaging" onChange={handleProduct} value={val.Packaging} />
                                        </div>
                                        <div className='flex flex-col justify-center w-1/12 my-1 text-center'>
                                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Quantità</label>
                                            <input style={{ border: "solid gray 1px", width: "100%", textAlign: "center" }} required placeholder="00" type="text" name="career3" onChange={handleProduct} />
                                        </div>
                                        <div className='flex flex-col justify-center w-1/12  my-1 text-center'>
                                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Peso Kg</label>
                                            <input style={{ border: "solid gray 1px", width: "100%", textAlign: "center" }} required placeholder="00" type="text" name="career2" onChange={handleProduct} />
                                        </div>
                                        <div className='flex flex-col justify-center w-1/12 my-1 text-center'>
                                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Prezzo Netto</label>
                                            <input style={{ border: "solid gray 1px", width: "100%", textAlign: "center" }} required placeholder="00" type="text" name="netPrice" onChange={handleProduct} value={val.netPrice} />
                                        </div>
                                        <div className='flex flex-col justify-center w-1/12  my-1 text-center'>
                                            <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Prezzo Lordo</label>
                                            <input style={{ border: "solid gray 1px", width: "100%", textAlign: "center" }} required placeholder="00" type="text" name="grossPrice" onChange={handleProduct} value={val.grossPrice} />
                                        </div>
                                        <div className='flex flex-col justify-center w-1/12 my-1 text-center'>
                                        ...
                                        <div className='flex flex-col justify-center w-1/12 my-1 text-center'>
                                            ...
                                            <input style={{ border: "solid gray 1px", width: "100%", textAlign: "center" }} required placeholder="00" type="text" name=" IVA" onChange={handleChange} value={val.IVA} />
                                        </div>
                        ...
                        <div className='flex gap-2'>
                            <div className='flex flex-column justify-center w-3/12'>
                                <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Descrizione</label>
                                <input type="text" style={{ border: "solid gray 1px", width: "100%" }} required name="productDescription" placeholder="--Seleziona Descrizione--" onChange={handleProduct} value={productData.productDescription} />
                            ...
                            <div className='flex flex-col justify-center w-1/12  my-1 text-center'>
                                <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Imballo</label>
                                <input style={{ border: "solid gray 1px", width: "100%", textAlign: "center" }} required placeholder=".." type="text" name="Packaging" onChange={handleProduct} value={productData.Packaging} />
                            </div>
                            <div className='flex flex-col justify-center w-1/12 my-1 text-center'>
                                <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Quantità</label>
                                <input style={{ border: "solid gray 1px", width: "100%", textAlign: "center" }} required placeholder="00" type="text" name="career3" onChange={handleProduct} />
                            ...
                            <div className='flex flex-col justify-center w-1/12 my-1 text-center'>
                                <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Prezzo Netto</label>
                                <input style={{ border: "solid gray 1px", width: "100%", textAlign: "center" }} required placeholder="00" type="text" name="netPrice" onChange={handleProduct} value={productData.netPrice} />
                            </div>
                            <div className='flex flex-col justify-center w-1/12  my-1 text-center'>
                                <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Prezzo Lordo</label>
                                <input style={{ border: "solid gray 1px", width: "100%", textAlign: "center" }} required placeholder="00" type="text" name="grossPrice" onChange={handleProduct} value={productData.grossPrice} />
                            </div>
                            <div className='flex flex-col justify-center w-1/12 my-1 text-center'>
                                <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0">Imponibile</label>
                                <input style={{ border: "solid gray 1px", width: "100%", textAlign: "center" }} required placeholder="00" type="text" name="career3" onChange={handleProduct} />
                            ...
                            <div className='flex flex-col justify-center w-1/12 my-1 text-center'>
                                <label style={{ fontWeight: "500", fontSize: "12px" }} className="my-0 py-0" onChange={handleProduct} >IVA %</label>
                                <input style={{ border: "solid gray 1px", width: "100%", textAlign: "center" }} required placeholder="00" type="text" name=" IVA" onChange={handleChange} value={productData.IVA} />
                            </div>
                        </div>
                        <div className='flex justify-end'>
                            <npan className='bg-gray-600 px-2 my-1 text-white font-bold' onClick={addProduct}>Aggiungi nuovo prodotto</npan>
                        </div>
                    </div>
